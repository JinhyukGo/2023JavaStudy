...
public class Ex02PreDefineException6 {
	...
	public static void main(String[] args)  {	
		...
		// Object 클래스를 단독적으로 생성한 경우, 다른 클래스와의 상속관계가 전혀 없는 상태이므로 이 상태에서는 형변환을 할 수 없어 예외 발생
		Object object = new Object();
		try {
			// 순수한 Object 객체이므로 자식 타입으로 형변환할 수 없음
	...
	/*
	String 객체가 인수로 전달되면서 매개변수를 통해 Object로 자동형변환되므로 여기에서 상속관계가 확인됨
	매개변수 o는 원래 String타입이었으므로 instanceof를 통해 STring임을 확인할 수 있고 이 경우에는 다운캐스팅이 가능하게 됨
	 */
