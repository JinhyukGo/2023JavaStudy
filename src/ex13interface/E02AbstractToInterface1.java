...
해당 클래스는 추상메서드를 포함하고 이으므로 하위에서 상속받게 되면 반드시 추상메서드를 오버라이딩해야 함
 */
abstract class PersonalNumberStorageAbs {
	...
	public abstract String searchPersonalInfo(String jiminNum);
}

/*
DTO(Data Transfer Object) : 데이터를 저장하고 전송하기 위한 용도의 객체
 - VO(Value Object)로 표현하기도 함
 - 해당 프로그램에서는 이름과 주민등록번호를 저장하는 용도로 사용
 */
